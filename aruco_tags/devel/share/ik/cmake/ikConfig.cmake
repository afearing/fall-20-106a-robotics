...
if("TRUE" STREQUAL "TRUE")
  set(ik_SOURCE_PREFIX /home/yalshinnawi/fall-20-106a-robotics/aruco_tags/src/ik)
  set(ik_DEVEL_PREFIX /home/yalshinnawi/fall-20-106a-robotics/aruco_tags/devel)
  set(ik_INSTALL_PREFIX "")
  set(ik_PREFIX ${ik_DEVEL_PREFIX})
else()
  set(ik_SOURCE_PREFIX "")
  set(ik_DEVEL_PREFIX "")
  set(ik_INSTALL_PREFIX /home/yalshinnawi/fall-20-106a-robotics/aruco_tags/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'ik' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/yalshinnawi/fall-20-106a-robotics/aruco_tags/src/ik/${idir}'.  ${_report}")
    endif()
