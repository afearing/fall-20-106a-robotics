...
if("TRUE" STREQUAL "TRUE")
  set(ik_SOURCE_PREFIX /home/yalshinnawi/fall-20-106a-robotics/project_ws/src/ik)
  set(ik_DEVEL_PREFIX /home/yalshinnawi/fall-20-106a-robotics/project_ws/devel)
  set(ik_INSTALL_PREFIX "")
  set(ik_PREFIX ${ik_DEVEL_PREFIX})
else()
  set(ik_SOURCE_PREFIX "")
  set(ik_DEVEL_PREFIX "")
  set(ik_INSTALL_PREFIX /home/yalshinnawi/fall-20-106a-robotics/project_ws/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'ik' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'ik' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/yalshinnawi/fall-20-106a-robotics/project_ws/src/ik/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT ik_NUM_DUMMY_TARGETS)
      set(ik_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::ik::wrapped-linker-option${ik_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR ik_NUM_DUMMY_TARGETS "${ik_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::ik::wrapped-linker-option${ik_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND ik_LIBRARIES "${interface_target_name}")
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${ik_dep}_FOUND)
      find_package(${ik_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${ik_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
